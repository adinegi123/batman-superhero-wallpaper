...
import com.adi121.bat_superhero_man_wallpaper.databinding.ImageLoadsstateFooterBinding
...
class ImageLoadStateAdapter(private val retry: () -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): LoadStateViewHolder {
        val binding =
            ImageLoadsstateFooterBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class LoadStateViewHolder(private val binding: ImageLoadsstateFooterBinding) :
